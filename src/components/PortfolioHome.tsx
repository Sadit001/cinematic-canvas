  ...
  return (
    <div ref={rootRef} className="min-h-screen overflow-x-clip bg-paper font-grotesk text-ink selection:bg-signal selection:text-paper">
      <header className={`fixed inset-x-0 top-0 z-50 border-b transition-all duration-500 ${scrolled || menuOpen ? "border-ink/15 bg-paper/95 shadow-nav backdrop-blur-md" : "border-transparent bg-transparent"}`}>
        ...
        <div className={`absolute inset-x-0 top-[68px] overflow-hidden bg-ink text-paper transition-[height,opacity] duration-500 md:hidden ${menuOpen ? "h-[calc(100svh-68px)] opacity-100" : "pointer-events-none h-0 opacity-0"}`}>
      ...
      <main>
        <section id="top" data-hero className="relative mx-auto min-h-svh max-w-[1400px] px-5 pb-12 pt-28 lg:px-10 lg:pb-24 lg:pt-32">
